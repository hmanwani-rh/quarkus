...
+
--
The Quarkus application itself needs to validate that usernames, passwords, and roles are managed securely.
This can introduce significant complexity to the application.
Depending on the use case, other authenticatio mechanisms delegate username, password, and role management to specialized services.
--